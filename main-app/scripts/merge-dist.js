...
console.log('\n🚀 访问:')
console.log('   首页:        http://localhost:4000/qiankun-demo/')
console.log('   Vue 子应用:  http://localhost:4000/qiankun-demo/#/sub-vue')
console.log('   React 子应用: http://localhost:4000/qiankun-demo/#/sub-react')
